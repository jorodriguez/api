...
public class CoSucursal implements Serializable {

    private static final long serialVersionUID = -1672673893;
    ...
    public CoSucursal(CoSucursal value) {
        this.id = value.id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final CoSucursal other = (CoSucursal) obj;
        if (id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CoSucursal (");
