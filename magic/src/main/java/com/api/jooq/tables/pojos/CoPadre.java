...
public class CoPadre implements Serializable {

    private static final long serialVersionUID = -2052949364;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final CoPadre other = (CoPadre) obj;
        if (id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CoPadre (");
